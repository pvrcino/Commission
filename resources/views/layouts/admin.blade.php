    ...
    <body id="body-pd" class="bg-dark">
            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav_list">
                        ...
                        <a href="/admin/afiliacao" class="nav_link">
                            <i class='bx bx-package nav_icon'></i>
                            <span class="nav_name">Afiliações</span>
                        </a>
                        <a href="/admin/financeiro" class="nav_link">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function(event) {
                ...
                @endphp
                if ("{{ $route }}" == "home") {
                    linkColor[0].classList.add('actived')
                } else if ("{{ $route }}" == ("afiliacao")) {
                    linkColor[1].classList.add('actived')
                }else if ("{{ $route }}" == ("financeiro")) {
                    linkColor[2].classList.add('actived')
                }
            });
        </script>
    </body>
